...
build: $(BUILD_DIR) $(BUILD_DIR)/index.html $(BUILD_DIR)/call-for-papers.html $(BUILD_DIR)/local-info.html $(BUILD_DIR)/program.html $(BUILD_DIR)/registration.html
...
$(BUILD_DIR)/program.html: talks.rkt program.rkt
